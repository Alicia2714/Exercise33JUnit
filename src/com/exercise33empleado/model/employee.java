...
public class employee {
	...
	public double calculateBrute(String employeeType, double salesPerMonth, int extraHours) {
		...
		final double SALES_SECOND_BONUS_LIMIT = 1000.0;
		...
		/*
		 * //Way 1 if(employeeType.equals("salesEmployee")) { bruteSalary = 1000.0; }
		 * else { bruteSalary = 1500.0; }
		 * 
		 * //Way 2 if(employeeType.equals("salesEmployee")) bruteSalary = 1000.0; else
		 * if(employeeType.equals("salesManagement")) bruteSalary = 1500.0;
		 * 
		 * //Way 3 bruteSalary = (employeeType.equals("salesEmployee"))?1000.0:1500.0;
		 */

		return bruteSalary = (employeeType.equals(EmployeeTypes.salesEmployee.toString()))
				? SALARY_EMPLOYEE + salarySales + salaryHours
